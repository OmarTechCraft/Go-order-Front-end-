...
import "../../styles/BusTerms.css"; // Link to your CSS file
...
const TermsConditions: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="main-content"> {/* This is your main flex container */}
        <Sidebar_2 /> {/* Your Sidebar component */}
        <div className="page-content-area"> {/* New wrapper for all page content */}
          <div className="terms-container">
            <div className="terms-header-section">
              <button
                className="back-button"
                onClick={() => navigate("/bus-settings")} // Navigates back to settings
              >
                <FaArrowLeft />
              </button>
            ...
            <p>
              ...
              conforms to the terms and conditions outlined herein. By
              accessing or using the GoOrder app or services (collectively, the
              "Services"), you agree to be bound by these Terms & Conditions. If
              you do not agree to these Terms & Conditions, please do not use
              our Services.
            </p>
            ...
            <p>
              ...
              operate these terms or any applicable laws.
            </p>
