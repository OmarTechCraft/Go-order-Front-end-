...
import "../../styles/PrivacyNotice.css"; // CSS for this page
  ...
  return (
    <>
      ...
      <div className="privacy-notice-container">
        ...
        <p>
          This Privacy Notice explains how [Your Company Name] collects, uses,
          and protects your personal data when you use our services. We are
          committed to ensuring the privacy and security of your information.
        </p>
